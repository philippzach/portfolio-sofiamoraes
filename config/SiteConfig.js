module.exports = {
  ...
  siteTitle: 'Sofia Moraes | Design and Product Photography', // Navigation and Site Title
  siteTitleAlt: 'Professional Graphic and Web Desginer with an eye for photography', // Alternative Site title for SEO
  siteUrl: 'https://sofiamoraes.com', // Domain of your site. No trailing slash!
  siteLanguage: 'en', // Language Tag on <html> element
  siteLogo: '/logos/logo-1024.png', // Used for SEO and manifest
  siteDescription: 'Portfolio of Sofia Moraes',
  //siteFBAppID: '123456789', // Facebook App ID
  //userTwitter: 'emma', // Twitter Username
  // og: Meta Tags
  //ogSiteName: 'emma', // Facebook Site Name
  googleAnalyticsID: 'UA-120790716-1',
  copyright: 'Copyright Philipp Zach © 2018. All rights reserved.', // Copyright in the footer of the site
