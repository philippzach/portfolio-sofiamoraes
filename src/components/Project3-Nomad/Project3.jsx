    ...
    <div className={styles.container}>
      <div className={styles.floatright} style={{textAlign: 'right', marginTop: '4em', marginBottom: '4em'}}>
        ...
        <p className={styles.text}>
          Is a mobile application which presents a series of soulful yoga practices curated for daily use. Designed to help people build a
          morning routine, connect with other yogis, or simple disconnect from a busy life.
        </p>
      </div>
    ...
    <div className={styles.container}>
      <section className={styles.content} style={{ marginTop: '6em'}}>
        <div className={styles.divleft}>
          ...
          <p className={styles.text}>I incorporate bluish tones into the desgin which habe the characteristics of expressing tranquility, relaxation & feelings of well being.</p>
        </div>
